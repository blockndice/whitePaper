const translations = {
    fr: {
        ...
        'p2e-desc':         'La mécanique challenger / joueur fonctionne en Web2 pur et se branche sur Solana + pump.fun si le projet franchit le cap du succès.',
        ...
        'result-win-desc':  'Le Joueur reçoit la récompense. Vérifié automatiquement.',
    ...
    en: {
        ...
        'p2e-desc':         'The challenger / player mechanic runs in pure Web2 and plugs into Solana + pump.fun if the project crosses the success threshold.',
        ...
        'result-win-desc':  'The Player receives the reward. Verified automatically.',
    ...
    es: {
        ...
        'p2e-desc':         'La mecánica challenger / jugador funciona en Web2 puro y se conecta a Solana + pump.fun si el proyecto supera el umbral del éxito.',
        ...
        'result-win-desc':  'El Jugador recibe la recompensa. Verificado automáticamente.',
